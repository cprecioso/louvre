...
declare module "liftoff" {
  ...
  class Liftoff extends EventEmitter {
    ...
    launch(options: Liftoff.LaunchOptions, cb: (this: this, env: Liftoff.Env) => void): void
    ...
    processTitle?: string
    completions?: Function
    configFiles?: { [basename: string]: { [name: string]: Liftoff.PathArguments } }

    on<Event extends keyof Liftoff.Events>(event: Event, cb: Liftoff.Events[Event]): this
    once<Event extends keyof Liftoff.Events>(event: Event, cb: Liftoff.Events[Event]): this
    addEventListener<Event extends keyof Liftoff.Events>(event: Event, cb: Liftoff.Events[Event]): this
  }
